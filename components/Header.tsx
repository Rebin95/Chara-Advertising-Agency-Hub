...
import { SettingsIcon, TaskIcon, ProfileIcon, InstallIcon } from './icons';
...
export const Header: React.FC<HeaderProps> = ({ onNavigate, activeView, t }) => {
  return (
    <div className="flex justify-center mb-12">
      <nav className="flex items-center justify-between w-full max-w-3xl p-1.5 dark:bg-slate-950/50 bg-white/60 backdrop-blur-sm rounded-full border dark:border-slate-700/50 border-slate-200/80 shadow-md">
