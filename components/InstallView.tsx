...
const InstructionCard: React.FC<{ title: string, steps: string }> = ({ title, steps }) => (
    <div className="backdrop-filter backdrop-blur-xl dark:bg-slate-900/30 bg-white/30 rounded-2xl shadow-lg p-6 border dark:border-slate-700 border-slate-200">
